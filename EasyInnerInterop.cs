...
namespace EasyInnerSDK
{
    ...
    class EasyInnerInterop
    {
        ...
        [DllImport("EasyInner.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Winapi)]
        public static extern byte RequisitarCadastrarUsuarioLeitorInnerBio(int Inner, int TipoModBio, byte Solicitacao, string Usuario);

        [DllImport("EasyInner.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Winapi)]
        public static extern byte RespostaCadastrarUsuarioLeitorInnerBio(int Inner);
